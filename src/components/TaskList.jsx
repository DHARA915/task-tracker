      ...
      {tasks.length === 0 ? (
        ...
        <motion.ul className="space-y-4">
          {tasks.map(task => (
            <motion.li
              key={task.id}
              className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow p-4 ${task.completed ? 'opacity-80 border-l-4 border-green-500' : ''
                }`}
              ...
              {editingTaskId === task.id ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 rounded focus:outline-none focus:ring-2 ${darkMode
                ...
                <div className="flex items-start">
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 w-5 h-5 mt-1 mr-3 rounded border-2 flex items-center justify-center ${task.completed
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        {task.description && (
                          <p className={`mt-1 ${task.completed ? 'line-through' : ''
                      ...
                      <div className="flex space-x-2 ml-2">
                        <button
                          ...
                          className={`p-1 transition ${darkMode ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-400 hover:text-indigo-300'
                            }`}
                          title="Edit"
                        >
                        ...
                        <button
                          ...
                          className={`p-1 transition ${darkMode ? 'text-red-400 hover:text-red-300' : 'text-red-600 hover:text-red-700'
                            }`}
                          title="Delete"
                        >
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${priorityColors[task.priority || 'medium']
                        }`}>
